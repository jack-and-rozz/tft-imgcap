...
├── annotated_pics
│   └── bestsatojp_10.8
│       ├── 00099997.jpg # A screenshot of a TFT game.
│       └── 00099997.xml # An anotation summary generated by LabelImg to the screenshot above.
│
...
└── clipped # Generated by 'scripts/clip_annotated_pics.py'.
    ├── ahri.0.png # A clipped picture based on the annotations.
    ├── ahri.1.png
    ...
